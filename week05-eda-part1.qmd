...
Answer: There are more higher special attacks than 65
...
ggplot(pokedata, aes(x = sp_atk)) + 
  geom_histogram() +
  coord_cartesian(ylim = c(0, 25), xlim = c(190, 200))
...
#squaring correlation value gives % of coverage.
```
...
- first line is 25%, middle is 50% (and the median) and end of the box is 75% of the data. end of lines are minimum and maximum. dots are outliers.
