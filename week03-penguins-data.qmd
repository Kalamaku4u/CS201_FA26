...
ggplot(data = penguins_data, aes(x = flipper_length_mm, fill = species)) +
  geom_histogram(alpha = 0.80) + #alpha changes transparency
  scale_fill_manual(values = c("darkorange", "darkorchid", "cyan4"), name = "Penguin Species") +
  theme_bw() + #bw means black and white background theme 
...
ggplot(data = penguins_data, aes(x = flipper_length_mm, fill = species)) +
  geom_histogram(alpha = 0.80) + #alpha changes transparency
  scale_fill_viridis_d(option = "mako", name = "Penguin Species") +
  theme_bw() + #bw means black and white background theme 
  labs(title = "Palmer Penguins' Flipper Length",
       subtitle = "Three species observed on three islands in the Palmer Archipelago",
       x = "Flipper Length (mm)",
...
ggplot(data = penguins_data, aes(y = flipper_length_mm, fill = species)) +
  geom_boxplot()
...
ggplot(data = penguins_data, aes(x = species, y = flipper_length_mm, fill = species)) +
  geom_boxplot() +
  geom_jitter(size = 0.5) + #spread of points
  theme_bw() +
  scale_fill_manual(values = c("darkorange", "darkorchid", "cyan4"), name = "Penguin Species") +
  labs(title = "Palmer Penguins' Flipper Length",
       subtitle = "Three species observed on three islands in the Palmer Archipelago",
...
ggplot(data = penguins_data, aes(x = flipper_length_mm, y = body_mass_g, color = species, shape = island)) +
  geom_point() +
  scale_shape_manual(values = c(20,11,14))
...
ggplot(data = penguins_data, aes(x = culmen_depth_mm, fill = species)) +
  ...
  labs(title = "Palmer Penguins' culmen Length",
       subtitle = "Three species observed on three islands in the Palmer Archipelago",
       x = "Culmen Length (mm)",
       y = "Number of Penguins")
...
plotname <- ggplot(data = penguins_data, aes(x = culmen_depth_mm, y = body_mass_g, color = species, shape = island)) +
  geom_point() +
  theme_bw() +
  scale_color_viridis_d(option = "mako") +
  labs(title = "Palmer Penguins' culmen Length",
